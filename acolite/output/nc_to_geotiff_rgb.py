...
def nc_to_geotiff_rgb(f, settings = {}, use_gdal_merge_import = True, \
    ...
    for base in ['rhot', 'rhos']:
        ...
        if setu['use_gdal_merge_import']:
            ...
            cmd = ['python','/home/tj/miniconda3/envs/intelliport/bin/gdal_merge.py',  "-o '{}'".format(outfile), '-separate'] + tempfiles
            ...
            cmd_subp = ['python','/home/tj/miniconda3/envs/intelliport/bin/gdal_merge.py','-o',outfile, '-separate'] + tempfiles_
            print(cmd_subp)
